<html>
  ...
  <div id='page-wrap'>
    ...
    <span><a href='obtenerPreguntasSW.php' id="obtenerPregunta">Obtener preguntas Servicio</a></span>
	</nav>
    <section class="main" id="s1">
    
	<div>
		<form enctype="multipart/form-data" id='fpreguntas' name='fpreguntas' action="" method='POST'>
			<p>Introduce el ID de la pregunta:   
			<input type='text' id = 'idPregunta' name = 'idPregunta'> </br>
      </br> </br>
			<input type ='button' id="botonenviar" value='Enviar' class = "boton" onclick="obtenerPregunta();"/>
      </br></br>
      <div class="respuesta">
        <label id="respuesta" style="font-size: 50px;"></label>
      </div>
		</form>
...
$link = mysqli_connect("localhost","id2920920_amaiajokin","","id2920920_quiz");
  ...
  echo "<script> $('#obtenerPregunta').attr('href','obtenerPreguntasSW.php?usuario=$email');</script>";
  mysqli_close($link);
}
